...
const copyValidations = [
  { validation: _.isDate, copy: copyDate },
  { validation: _.isSet, copy: copySet },
  { validation: _.isMap, copy: copyMap },
  { validation: Array.isArray, copy: copyArray },
  { validation: _.isSymbol, copy: copySymbol },
  { validation: _.isTypedArray, copy: copyTypedArray },
  { validation: _.isObject, copy: copyObject },
  { validation: _.isRegExp, copy: copyRegexp },
];
